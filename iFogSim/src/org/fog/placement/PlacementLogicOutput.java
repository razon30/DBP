...
public class PlacementLogicOutput {
    ...
    Map<Integer, Map<Application, List<ModuleLaunchConfig>>> perDevice = new HashMap<>(); // <Device, <App, List of
    // (module, number of instance)>>

    Map<Integer, List<Pair<String, Integer>>> serviceDiscoveryInfo = new HashMap<>(); //<microservice, list of (Pair
    // of device id and
